...
namespace DotNet.Controllers
{
    ...
    public class LettersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Content,UserId")] Letter letter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Content,UserId")] Letter letter)
        {
            if (id != letter.Id)
            {
                return NotFound();
